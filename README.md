...
Messages contains 2 scripts that are connected by socket library witch uses internet connection and open ports to communicate with each other. This is how to make it work in 4 steps:
...
4. In the second console, the application asks for an IP address. If you do it locally, type: 127.0.0.0 (local IP)
And you done!
